...
void setup_camera_screen(lv_ui *ui, uint32_t time, uint32_t delay)
{
    ...
    lv_obj_remove_style_all(ui->takepic_btn);                                                      // �Ƴ���ʽ
    lv_obj_set_size(ui->takepic_btn, 50, 40);                                                      // ���ô�С
    lv_obj_align(ui->takepic_btn, LV_ALIGN_RIGHT_MID, -20, 0);
    lv_obj_set_style_radius(ui->takepic_btn, 5, 0);                                                // ���õ�Բ��
    lv_obj_set_style_bg_color(ui->takepic_btn, lv_color_hex(COLOR_DODGER_BLUE), 0);                // ���ñ�����ɫ
    lv_obj_set_style_bg_opa(ui->takepic_btn, LV_OPA_0, 0);                                         // ����͸����
    lv_obj_set_style_bg_color(ui->takepic_btn, lv_color_hex(COLOR_DODGER_BLUE), LV_STATE_FOCUSED); // ���ñ��۽�ʱ���״̬��ɫ
    lv_obj_set_style_bg_opa(ui->takepic_btn, LV_OPA_50, LV_STATE_FOCUSED);                         // ���۽�ʱ���͸���ȣ��Ӷ�����������
    lv_obj_set_style_bg_opa(ui->takepic_btn, LV_OPA_80, LV_STATE_PRESSED);                         // ������ʱ��ı���͸����
